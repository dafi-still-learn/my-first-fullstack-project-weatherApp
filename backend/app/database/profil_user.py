...
def tabel_users_profil():
    ...
    try:
        ...
        cursor.execute(
            """
            CREATE TABLE IF NOT EXISTS tabel_users_profil_cuaca_baru_1(
                ...
                FOREIGN KEY (user_id)
                REFERENCES tabel_user_cuaca_baru_1(id)
            )
            """
        )
...
def input_users_profil(user_id, nama_panjang, nama_panggilan, umur):
    ...
    try:
        ...
        cursor.execute(
            """
            INSERT INTO tabel_users_profil_cuaca_baru_1(user_id, nama_panjang, nama_panggilan, umur)
            VALUES(?, ?, ?, ?)
...
def tampilkan_data_users_profil():
    ...
    try:
        ...
        cursor.execute(
            """
            SELECT * FROM tabel_users_profil_cuaca_baru_1
            """
        )
...
def validate_data_users_profil(user_id):
    ...
    try:
        ...
        cursor.execute(
            ...
            FROM tabel_users_profil_cuaca_baru_1
            WHERE user_id = ?
            """, (user_id, )
        )
